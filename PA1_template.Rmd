...
The mean of the total nuber of steps per day is `r MeanPerDay`, while the median is `r MedianPerDay`.
...
The number of missing values in the dataset is `r NA.vals`.
...
The new mean is `r MeanPerDay.2` while the previous mean was `r MeanPerDay`.

The new median is `r MedianPerDay.2` while the previous median was `r 
MedianPerDay`.
